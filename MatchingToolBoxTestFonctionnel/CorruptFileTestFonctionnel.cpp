...
TEST(CorruptFile_SystemTest, CorruptFile_csv_numTAR_Supp_Separateurs) {
	string result_path = (string)_shared_path_CORRUPT_FILE + "resultat_target_numeric_ref_numeric_lvn_char_csv";
	string result_file = result_path + _p + "1.txt";
	string target_file = (string)_shared_path_CORRUPT_FILE + "target_numeric.csv";
...
TEST(CorruptFile_SystemTest, CorruptFile_xml_charTAR_Supp_Separateurs) {
	string result_path = (string)_shared_path_CORRUPT_FILE + "resultat_target_character_ref_character_lvn_char_xml";
	string result_file = result_path + _p + "1.txt";
	string target_file = (string)_shared_path_CORRUPT_FILE + "target_character.xml";
